...
GUARDIAN_API_KEY = "3aa30944-21cc-472e-8b5e-9e33cf6f215a"
...
# Function to fetch relevant articles from The Guardian
...
def verify_article_route():
    ...
    # Fetch relevant articles from The Guardian
    relevant_articles = fetch_guardian_articles(article.get("title", ""))

    return jsonify({
        "article": article, 
        "claim_verification": claim_verification,
        "relevant_articles": relevant_articles.get("response", {}).get("results", []) if relevant_articles else []
    })
